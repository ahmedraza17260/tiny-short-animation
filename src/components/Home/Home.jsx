            ...
            <Grid container spacing={5}>
              <Grid item xs={12} sm={6}>
                <div ref={left.ref} className={home.content}>
                  <ScrollAnimation animateIn="animate__fadeInTopLeft" delay={100} >
                    <h1 className={home.heading}>Tiny Short Animation</h1>
                    ...
                    <div className={home.button}>
                      <Button variant="contained" className={home.btn}> Contact Us </Button>
                    </div>
                  </ScrollAnimation>
